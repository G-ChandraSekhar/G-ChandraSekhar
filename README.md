<h1 align="center">Hi 👋, I'm Chandra Sekhar Govindarajula</h1>
...
- 🎓 Recently completed my **MS in Computer Science** at **Stony Brook University** (GPA 3.64)
- 🔬 Worked as a **Research Engineer** under Prof. Karina Torres Castro, building **BrookMinds** — a multi-agent agentic RAG platform using LangGraph, GPT-4o-mini, Kafka, FastAPI, and pgvector
- 💼 Previously a **Software Engineering Intern @ Pfizer**, building **VOX**, an enterprise GPT-4 inference platform processing 10TB+ clinical data
